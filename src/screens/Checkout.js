...
/** Get the cart items inf from store  /redux/slices/CartSlice *****/
      ...
      <ScrollView>
            ...
            renderItem={({item, index}) => {
              return (
                ...
                <TouchableOpacity
                  ...
                  <View>
                    {/*** Product Name , if title.length > 25, cut the string and show 25 chars + .... */}
                    <Text style={styles.name}>
                      {item.title.length > 25
                        ? item.title.substring(0, 25) + '...'
                        : item.title}
                    </Text>
                    {/*** Product Description, if description.length > 30, cut the string and show 30 chars + .... */}
        ...
        <View style={styles.addressView}>
          ...
          <Text
           ...
           {/*** Button to Edit Address block end*/}
        </View>
         {/*** Show Address View block end*/}
        ...
        <Text
         ...
         {/*** Show Selected Address block end */}
        {/*** Button to pay and order */}
        <CustomButton
          bg={'green'}
          title={'Pay & Order'}
          color={'#fff'}
        ...
        />
       {/*** Button to pay and order - block end */} 
      </ScrollView>
    </SafeAreaView>
  );
};
