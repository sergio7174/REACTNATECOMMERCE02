...
export default function ProductDetail() {
    ...
    const checkUserStatus = async () => {
      ...
      /*** IS_USER_LOGGED_IN is set at Login component*/
  ...
  return (
    ...
    {/*** Top Bar Component */}
     <Header
        ...
        />
       <ScrollView>
         {/*** route.params.data.image, cause data was send by nevigation router from home map data: item */}
         ...
         <Text style={styles.desc}>{route.params.data.description}</Text>
          ...
          {/*** Add to Wish list button block end*/}
          {/*** Add to Card button */}
           <CustomButton
            bg={'#FF9A0C'}
            title={'Add To Cart'}
